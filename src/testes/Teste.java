...
class Teste {
	/**
	 * Realiza os testes para verificar se os campos do cadastro de filiais foram
	 * respeitados.
	 */
	@Test
	...
	void testEditarCadastrarPatrimonioVeiculo() {
		...
		String tipoVeiculoErrado = "135646";
		String cor = "azul";
	...
	/**
	 * Realiza os testes para verificar se os campos do cadastro e edição de
	 * equipamento de construção foram respeitados, alem de verificar se os
	 * patrimonios cadastrados estão respeitando os castings da classe de
	 * equipamentoConstrucao.
	 */
	@Test
	...
	/**
	 * Realiza os testes para verificar se os campos do cadastro e edição de
	 * patrimonio eletronico foram respeitados, alem de verificar se os patrimonios
	 * cadastrados estão respeitando os castings da classe EquipamentoEletronico.
	 */
	@Test
